...
# My Contributions
As a Software Engineer at Omnidots, I utilised Python, Reactjs, GraphQL and Linux along with other tools and techs to develop many features of the product.
