...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '1rem' }}>
  <div style={{ textAlign: 'center' }}>
    <img src="../projects/smart-learning/dashboard.png" alt="homepage" style={{ width: '100%', height: '100%', objectFit: 'cover', margin: '0px !important' }} />
  </div>
  <div style={{ textAlign: 'center' }}>
    <img src="../projects/smart-learning/table.png" alt="comparison" style={{ width: '100%', height: '100%', objectFit: 'cover', margin: '0px !important' }} />
  </div>
  <div style={{textAlign: 'center' }}>
    <img src="../projects/smart-learning/assesments.png" alt="assessment page" style={{ width: '100%', height: '100%', objectFit: 'cover', margin: '0px !important' }} />
  </div>
  <div style={{ textAlign: 'center' }}>
    <img src="../projects/smart-learning/team_building.png" alt="team creation" style={{ width: '100%', height: '100%', objectFit: 'cover', margin: '0px !important' }} />
  </div>
  <div style={{ textAlign: 'center' }}>
    <img src="../projects/smart-learning/teams.png" alt="teams" style={{ width: '100%', height: '100%', objectFit: 'cover', margin: '0px !important' }} />
  </div>
</div>
<br/>
# My Contributions
